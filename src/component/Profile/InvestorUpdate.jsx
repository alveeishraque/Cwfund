...
// console.log('b',userInfo.id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://venture-xbackend.vercel.app/investor-profile/${userInfo?._id}`, {
                method: 'PUT',
                headers: {
    ...
    useEffect(() => {
        if (userInfo?._id) {
            fetch(`https://venture-xbackend.vercel.app/investor-profile/${userInfo._id}`)
